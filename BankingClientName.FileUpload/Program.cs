...
using BankingClientName.FileUpload.DBConnectvity;
using BankingClientName.FileUpload.Repository;
using BankingClientName.FileUpload.Service;
...
//Make sure if you work with automappaer .you need to load the automapper assembly at runtime by using this way.
